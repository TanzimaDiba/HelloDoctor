<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Appointment_Confirm.aspx.cs" Inherits="Appointment_Confirm" %>
			...
			<div class="main">
				<div class="indent-left">
					<div class="wrapper">
						<article class="col-1">
                            <h3>Thank you..</h3>
                            <p id="thanks">You appointment is confirmed.<br />Now you also have an account.You can login using the email and password you provied.</p>
						</article>
					</div>
				</div>
			</div>
