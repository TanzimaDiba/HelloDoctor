...
public partial class Patient_Online_Payment : System.Web.UI.Page
{
    ...
    protected void Button_yes_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd2 = new SqlCommand("INSERT INTO Prescription (Doc_Name, Doc_Email, Appointment_Date, Serial_No, Patient_Email, Medicine, Advice, Test, Next_Date, Paid, Payment_Method, No_Visit, Patient_Name) values(@Doc_Name, @Doc_Email, @Appointment_Date, @Serial_No, @Patient_Email, @Medicine, @Advice, @Test, @Next_Date, @Paid, @Payment_Method, @No_Visit, @Patient_Name)", con2);
        ...
        cmd2.Parameters.AddWithValue("@Medicine", "Not set yet");
        cmd2.Parameters.AddWithValue("@Advice", "Not set yet");
        cmd2.Parameters.AddWithValue("@Test", "Not set yet");
        cmd2.Parameters.AddWithValue("@Next_Date", "Not set yet");
        cmd2.Parameters.AddWithValue("@Paid", "No");
        cmd2.Parameters.AddWithValue("@Payment_Method", "Online");
