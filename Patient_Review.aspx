<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Patient_Review.aspx.cs" Inherits="Patient_Review" %>
                        ...
                        <asp:ListView ID="ListView_Prescription" runat="server" DataSourceID="SqlDataSource_Prescription">
                            ...
                            <ItemTemplate>
                                <ul id="view">
                                    ...
                                    <asp:Button ID="b_review" runat="server" Text="Give Review" OnCommand="Button_Click_Give_Review" CommandArgument='<%#Eval("Doc_Email") %>' AutoDataBind="true" CssClass="button"/>
                                </ul>
                                <hr />
                            </ItemTemplate>
