		...
		<section id="content" style="height:auto;">
			<div class="main">
				...
				<div class="indent-left">
					<div class="wrapper">
		            <asp:SqlDataSource ID="SqlDataSource_Admin_Edit" runat="server" ConnectionString="<%$ ConnectionStrings:Admin_Edit_ConnectionString %>" SelectCommand="SELECT * FROM [Admin_Edit] WHERE Section='Latest_News'"></asp:SqlDataSource>
