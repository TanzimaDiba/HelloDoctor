<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Patient_Reg_Confirm.aspx.cs" Inherits="Patient_Reg_Confirm" %>
			...
			<div class="main">
				<div class="indent-left">
					<div class="wrapper">
						<article class="col-1">
                            <h3>Thank you..</h3>
                            <p id="thanks">Your account has been created successfully.<br />Now you can login to your account using the email and password you provided..</p>
						</article>
					</div>
				</div>
			</div>
