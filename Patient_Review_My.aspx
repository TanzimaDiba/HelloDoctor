<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Patient_Review_My.aspx.cs" Inherits="Patient_Review_My" %>
				...
				<div class="indent-left">
					<div class="wrapper">
						<article class="col-1">
						    ...
						    <asp:SqlDataSource ID="SqlDataSource_Review" runat="server" ConnectionString="<%$ ConnectionStrings:Review_ConnectionString %>" SelectCommand="SELECT * FROM [Review] WHERE Patient_Email=@Patient_Email">
                                <SelectParameters>
