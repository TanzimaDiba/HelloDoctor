<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Slider2.aspx.cs" Inherits="Slider2" %>
		...
		<section id="content">
			<div class="main">
				<div class="indent-left">
					...
					<p style="font-size:17px; line-height:25px;"><span style="font-size:40px; line-height:5px; color:cornflowerblue;">For Doctors</span> we offer them to display information about their work, medical degree and achievement.
                                                                                                                                      Each doctor have an individual account and we strictly follow our privacy policy.We keep track of each doctor's
                                                                                                                                      patient's record and its not for public display.(Not even Admin have access to these information)
