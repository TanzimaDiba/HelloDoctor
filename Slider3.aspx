<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Slider3.aspx.cs" Inherits="Slider3" %>
		...
		<section id="content">
			<div class="main">
				<div class="indent-left">
					...
					<p style="font-size:17px; line-height:25px;"><span style="font-size:40px; line-height:5px; color:cornflowerblue;">For Patients & Visitors</span> we provide information about doctors of various locations in Bangladesh.
                                                                                                                                      It is ensured that each is doctor is authenticated and qualified.Patient can have account while they take appointment.
                                                                                                                                      Both taking appointment and payment is very easy and online(Offline/cash payment is also avaiable).Even visitors
                                                                                                                                      have access to our doctors list ,their profile and appointment information.We always keep users(doctor, patient & visitors)
