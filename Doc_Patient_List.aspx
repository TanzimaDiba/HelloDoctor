<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Doc_Patient_List.aspx.cs" Inherits="Doc_Patient_List" %>
			...
			<div class="main">
				...
				<div class="indent-left">
					<div class="wrapper">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource_Prescription" runat="server" ConnectionString="<%$ ConnectionStrings:Prescription_ConnectionString %>" SelectCommand="SELECT * FROM [Prescription] WHERE Doc_Email=@Doc_Email AND Paid='Yes'">
                                <SelectParameters>
