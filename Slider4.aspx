<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Slider4.aspx.cs" Inherits="Slider4" %>
		...
		<section id="content">
			<div class="main">
				<div class="indent-left">
					...
					<p style="font-size:17px; line-height:25px;"><span style="font-size:40px; line-height:5px; color:cornflowerblue;">Review</span> we encourage patients to give their feedback about doctor they visited.
                                                                                                                                      We send these reviews to the doctors so that they can have an idea about thei services and
                                                                                                                                      take necessary improvement and change.It betters their services and treatment method.
